...
class Toto(torch.nn.Module, ModelHubMixin):
    ...
    Esta classe representa o modelo principal usado para previsão de séries temporais.
    Usada em main.py para carregar um modelo pré-treinado (from_pretrained), compilar e executar previsões.
